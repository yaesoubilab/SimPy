...
Tests.test_betabinomial(rng, n=100, a=2, b=3, loc=1, scale=2)
...
Tests.test_gammapoisson(rng, a=2, gamma_scale=4, loc=1, scale=1)
...
Tests.test_negativebinomial(rng, n=10, p=.2, loc=1)
