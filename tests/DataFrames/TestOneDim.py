...
print('print 40: ', df1.get_value(x_value=3))
print('')
...
print('Sample 1: ', df1.get_value(x_value=0).sample(rng))
print('Sample 2: ', df1.get_value(x_value=0.5).sample(rng))
print('Sample 3: ', df1.get_value(x_value=1).sample(rng))
print('Sample 4: ', df1.get_value(x_value=5).sample(rng))
print('')
